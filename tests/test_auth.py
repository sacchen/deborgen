...
def test_auth_not_required_when_token_not_set(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_auth_required_when_token_is_set(monkeypatch: pytest.MonkeyPatch) -> None:
